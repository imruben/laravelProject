    ...
    <div class="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div class="border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="p-6 flex text-gray-900 dark:bg-gray-800 dark:text-white ">
                ...
                @if(str_contains($post->user->avatar,"https://"))
                <img src="{{$post->user->avatar}}" class="h-14 w-auto rounded-lg mr-4 hover:h-100 hover:scale-150 ease-in duration-100" alt="palomon">
                @else
                <img src="/uploads/avatars/{{$post->user->avatar}}" class="h-14 w-auto rounded-lg mr-4 hover:h-100 hover:scale-150 ease-in duration-100" alt="palomon">
                @endif

                <div>
                    <div class="flex flex-row justify-start ">
                        <span class="text-lg mr-2">{{$post->user->username}} </span>
