...
tinymce.PluginManager.add("filemanager", function (editor) {
    ...
    function filemanager(callback, value, meta) {
        ...
        var akey = "key";
        if (
            typeof editor.settings.filemanager_access_key !== "undefined" &&
        ...
        var fldr = "";
        if (
            typeof editor.settings.filemanager_subfolder !== "undefined" &&
        ...
        var crossdomain = "";
        if (
            typeof editor.settings.filemanager_crossdomain !== "undefined" &&
            editor.settings.filemanager_crossdomain
        ) {
