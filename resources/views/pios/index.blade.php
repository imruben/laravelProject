        ...
        <div class="border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="p-6 flex text-gray-900 dark:bg-gray-800 dark:text-white ">
                ...
                <div class="flex pl-0 ml-5 ">
                    ...
                    <button data-modal-target="modal-delete-post" data-modal-toggle="modal-delete-post" data-id="{{$pio->id}}" type="button" class="remove-pio-button inline-flex justify-center  text-gray-500 rounded cursor-pointer hover:text-gray-900  dark:text-gray-400 dark:hover:text-white ml-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
