...
tinymce.PluginManager.add("responsivefilemanager", function (editor) {
    function responsivefilemanager_onMessage(event) {
        if (
            editor
                .getParam("external_filemanager_path")
                .toLowerCase()
    ...
    function openmanager() {
        ...
        if (
            typeof editor.getParam("filemanager_title") !== "undefined" &&
            editor.getParam("filemanager_title")
        ) {
            title = editor.getParam("filemanager_title");
        }
        var akey = "key";
        if (
            typeof editor.getParam("filemanager_access_key") !== "undefined" &&
            editor.getParam("filemanager_access_key")
        ) {
            akey = editor.getParam("filemanager_access_key");
        }
        var sort_by = "";
        if (
            typeof editor.getParam("filemanager_sort_by") !== "undefined" &&
            editor.getParam("filemanager_sort_by")
        ) {
            sort_by = "&sort_by=" + editor.getParam("filemanager_sort_by");
        }
        var descending = "false";
        if (
            typeof editor.getParam("filemanager_descending") !== "undefined" &&
            editor.getParam("filemanager_descending")
        ) {
            descending = editor.getParam("filemanager_descending");
        }
        var fldr = "";
        if (
            typeof editor.getParam("filemanager_subfolder") !== "undefined" &&
            editor.getParam("filemanager_subfolder")
        ) {
            fldr = "&fldr=" + editor.getParam("filemanager_subfolder");
        }
        var crossdomain = "";
        if (
            typeof editor.getParam("filemanager_crossdomain") !== "undefined" &&
            editor.getParam("filemanager_crossdomain")
        ) {
        ...
        const fileUrl =
            editor.getParam("external_filemanager_path") +
